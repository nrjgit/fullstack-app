...
const parkwhizKey = process.env.PARKWHIZ_KEY;  
        ...
        request
        .get(`http://api.parkwhiz.com/v4/quotes/?q=coordinates:41.8857256,-87.6369590&start_time=2018-04-23T12:00&end_time=2018-04-23T20:00&api_key=${parkwhizKey}`).then(res => {
                if (res.ok) {
